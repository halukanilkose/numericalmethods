...
method to determine the fuel element temperature distribution after 1.5s. The fuel element thermal properties are k=30 W/mK and α=5x10<sup>-6</sup>m<sup>2</sup>/s.
